...
#define TM_STB_L()  (GpioDataRegs.AIOCLEAR.bit.AIO6 = 1)
#define TM_STB_H()  (GpioDataRegs.AIOSET.bit.AIO6 = 1)
#define TM_CLK_L()  (GpioDataRegs.AIOCLEAR.bit.AIO4 = 1)
#define TM_CLK_H()  (GpioDataRegs.AIOSET.bit.AIO4 = 1)
#define TM_DIO_L()  (GpioDataRegs.AIOCLEAR.bit.AIO2 = 1)
#define TM_DIO_H()  (GpioDataRegs.AIOSET.bit.AIO2 = 1)
...
void LED_showfloat(Uint8 bit,float num);
#endif
